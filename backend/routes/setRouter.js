...
import { addEmptySet, getSet, editSet, getAllSets, getAllCardsNotInSet, deleteSet } from '../controllers/setController.js';
...
router.delete("/", authWithDiscordId, checkIfAdmin, deleteSet)
